 ...
 * وللتاجر تُؤخذ تلقائيًا في نهاية كل يوم (وتُستبدل نسخة اليوم السابق).
 */
 ...
 * · النسخة اليومية التلقائية للتاجر (وقابلة للتفعيل لأي دور من الإعدادات)
...
/** النسخة التلقائية مفعّلة افتراضيًا للتاجر — ويمكن تفعيلها/إيقافها لأي دور */
export function defaultAutoBackup(role: Role): boolean {
